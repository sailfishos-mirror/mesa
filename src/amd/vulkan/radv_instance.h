...
enum {
   ...
   RADV_DEBUG_ALL_BOS = 1ull << 6,
   RADV_DEBUG_NO_IB_CHAINING = 1ull << 7,
   RADV_DEBUG_DUMP_SPIRV = 1ull << 8,
   RADV_DEBUG_ZERO_VRAM = 1ull << 9,
   RADV_DEBUG_SYNC_SHADERS = 1ull << 10,
   RADV_DEBUG_DUMP_PREOPT_IR = 1ull << 11,
   RADV_DEBUG_INFO = 1ull << 12,
   RADV_DEBUG_STARTUP = 1ull << 13,
   RADV_DEBUG_CHECKIR = 1ull << 14,
   RADV_DEBUG_NOBINNING = 1ull << 15,
   RADV_DEBUG_NO_NGG = 1ull << 16,
   RADV_DEBUG_DUMP_META_SHADERS = 1ull << 17,
   RADV_DEBUG_LLVM = 1ull << 18,
   RADV_DEBUG_FORCE_COMPRESS = 1ull << 19,
   RADV_DEBUG_HANG = 1ull << 20,
   RADV_DEBUG_IMG = 1ull << 21,
   RADV_DEBUG_NO_UMR = 1ull << 22,
   RADV_DEBUG_NO_DISPLAY_DCC = 1ull << 23,
   RADV_DEBUG_NO_TC_COMPAT_CMASK = 1ull << 24,
   RADV_DEBUG_NO_VRS_FLAT_SHADING = 1ull << 25,
   RADV_DEBUG_NO_ATOC_DITHERING = 1ull << 26,
   RADV_DEBUG_NO_NGGC = 1ull << 27,
   RADV_DEBUG_DUMP_PROLOGS = 1ull << 28,
   RADV_DEBUG_NO_DMA_BLIT = 1ull << 29,
   RADV_DEBUG_DUMP_EPILOGS = 1ull << 30,
   RADV_DEBUG_NO_FMASK = 1ull << 31,
   RADV_DEBUG_SHADOW_REGS = 1ull << 32,
   RADV_DEBUG_EXTRA_MD = 1ull << 33,
   RADV_DEBUG_NO_GPL = 1ull << 34,
   RADV_DEBUG_NO_RT = 1ull << 35,
   RADV_DEBUG_NO_MESH_SHADER = 1ull << 36,
   RADV_DEBUG_NO_ESO = 1ull << 37,
   RADV_DEBUG_PSO_CACHE_STATS = 1ull << 38,
   RADV_DEBUG_NIR_DEBUG_INFO = 1ull << 39,
   RADV_DEBUG_DUMP_TRAP_HANDLER = 1ull << 40,
   RADV_DEBUG_DUMP_VS = 1ull << 41,
   RADV_DEBUG_DUMP_TCS = 1ull << 42,
   RADV_DEBUG_DUMP_TES = 1ull << 43,
   RADV_DEBUG_DUMP_GS = 1ull << 44,
   RADV_DEBUG_DUMP_PS = 1ull << 45,
   RADV_DEBUG_DUMP_TASK = 1ull << 46,
   RADV_DEBUG_DUMP_MESH = 1ull << 47,
   RADV_DEBUG_DUMP_CS = 1ull << 48,
   RADV_DEBUG_DUMP_NIR = 1ull << 49,
   RADV_DEBUG_DUMP_ASM = 1ull << 50,
   RADV_DEBUG_DUMP_BACKEND_IR = 1ull << 51,
   RADV_DEBUG_PSO_HISTORY = 1ull << 52,
   RADV_DEBUG_BVH4 = 1ull << 53,
   RADV_DEBUG_NO_VIDEO = 1ull << 54,
   RADV_DEBUG_VALIDATE_VAS = 1ull << 55,
   RADV_DEBUG_DUMP_BO_HISTORY = 1ull << 56,
   RADV_DEBUG_DUMP_IBS = 1ull << 57,
   RADV_DEBUG_VM = 1ull << 58,
   RADV_DEBUG_NO_SMEM_MITIGATION = 1ull << 59,
   RADV_DEBUG_FULL_SYNC = 1ull << 60,
   RADV_DEBUG_NO_TMZ = 1ull << 61,
   RADV_DEBUG_NO_HEAP = 1ull << 62,
