...
open_manual()
{
   ...
   static const char *contents[] = {
      ...
      "instructions, register operands must be plain rN GRFs (no subregisters,",
      "regions, or immediates).",
      "",
      "- @eot",
      "  Send an EOT message.",
      "",
      ...
      "address 0x30000000.",
      "",
      "The executor reserves r0..r1 for its own payload and r124..r127 for",
      "macros.  Macro operands are checked for overlap, but raw assembly",
