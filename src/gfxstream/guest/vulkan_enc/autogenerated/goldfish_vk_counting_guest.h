...
DEFINE_ALIAS_FUNCTION(count_VkPhysicalDeviceMaintenance6Features,
                      count_VkPhysicalDeviceMaintenance6FeaturesKHR)

DEFINE_ALIAS_FUNCTION(count_VkPhysicalDeviceMaintenance6Properties,
                      count_VkPhysicalDeviceMaintenance6PropertiesKHR)

DEFINE_ALIAS_FUNCTION(count_VkBindMemoryStatus, count_VkBindMemoryStatusKHR)

DEFINE_ALIAS_FUNCTION(count_VkBindDescriptorSetsInfo, count_VkBindDescriptorSetsInfoKHR)

DEFINE_ALIAS_FUNCTION(count_VkPushConstantsInfo, count_VkPushConstantsInfoKHR)

DEFINE_ALIAS_FUNCTION(count_VkPushDescriptorSetInfo, count_VkPushDescriptorSetInfoKHR)

DEFINE_ALIAS_FUNCTION(count_VkPushDescriptorSetWithTemplateInfo,
                      count_VkPushDescriptorSetWithTemplateInfoKHR)
...
DEFINE_ALIAS_FUNCTION(count_VkPhysicalDevicePipelineProtectedAccessFeatures,
