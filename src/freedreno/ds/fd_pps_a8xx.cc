...
void
FreedrenoDriver::setup_a8xx_counters()
{
   ...
   /* RBBM: 1/4 counters */
   auto PERF_RBBM_US_STATUS_MASKED = countable("RBBM", "PERF_RBBM_US_STATUS_MASKED");

   /* PC: 3/8 counters, BV_PC: 3/8 counters */
   auto PERF_PC_S_STALL_CYCLES_VFD = cbCountable("PC", "PERF_PC_S_STALL_CYCLES_VFD");
   auto PERF_PC_S_VERTEX_HITS = cbCountable("PC", "PERF_PC_S_VERTEX_HITS");
   auto PERF_PC_S_VS_INVOCATIONS = cbCountable("PC", "PERF_PC_S_VS_INVOCATIONS");

   /* TSE: 4/8 counters */
   auto PERF_TSE_BE_INPUT_PRIM = countable("TSE", "PERF_TSE_BE_INPUT_PRIM");
   auto PERF_TSE_BE_TRIVAL_REJ_PRIM = countable("TSE", "PERF_TSE_BE_TRIVAL_REJ_PRIM");
   auto PERF_TSE_BE_CLIPPED_PRIM = countable("TSE", "PERF_TSE_BE_CLIPPED_PRIM");
   auto PERF_TSE_BE_OUTPUT_VISIBLE_PRIM = countable("TSE", "PERF_TSE_BE_OUTPUT_VISIBLE_PRIM");
   ...
   counter("% Kernel Load Cycles", Counter::Units::Percent, [=]() {
          ...
          */
         return percent(PERF_RBBM_US_STATUS_MASKED - (PERF_SP_BUSY_CYCLES * number_of_usptp), PERF_CP_ALWAYS_COUNT);
      }
   );
   ...
   counter("GPU % Utilization", Counter::Units::Percent, [=]() {
          ...
          * PERFCOUNTER_GROUP_RBBM::COUNTABLE_6 = PERF_RBBM_STATUS_MASKED
          */
         return percent(PERF_RBBM_US_STATUS_MASKED, max_freq);
      }
   );
   ...
   counter("Avg Bytes / Vertex", Counter::Units::Byte, [=]() {
          ...
          */
         return safe_div(PERF_UCHE_VBIF_READ_BEATS_VFD * 32, cbSum(PERF_PC_S_VS_INVOCATIONS));
      }
   );
   ...
   counter("Average Polygon Area", Counter::Units::None, [=]() {
          ...
          * PERFCOUNTER_GROUP_SP::COUNTABLE_101 = PERF_SP_PIXELS
          */
         return safe_div(PERF_SP_PIXELS, PERF_TSE_BE_OUTPUT_VISIBLE_PRIM);
      }
   );
   counter("Average Vertices / Polygon", Counter::Units::None, [=]() {
          ...
          */
         return safe_div(cbSum(PERF_PC_S_VS_INVOCATIONS), PERF_TSE_BE_INPUT_PRIM);
      }
   );
   counter("Pre-clipped Polygons / Second", Counter::Units::None, [=]() {
          ...
          * PERFCOUNTER_GROUP_TSE::COUNTABLE_6 = PERF_TSE_INPUT_PRIM
          */
         return PERF_TSE_BE_INPUT_PRIM / time;
      }
   );
   counter("% Prims Clipped", Counter::Units::Percent, [=]() {
          ...
          * PERFCOUNTER_GROUP_TSE::COUNTABLE_6 = PERF_TSE_INPUT_PRIM
          */
         return percent(PERF_TSE_BE_CLIPPED_PRIM, PERF_TSE_BE_INPUT_PRIM);
      }
   );
   counter("% Prims Trivially Rejected", Counter::Units::Percent, [=]() {
          ...
          * PERFCOUNTER_GROUP_TSE::COUNTABLE_6 = PERF_TSE_INPUT_PRIM
          */
         return percent(PERF_TSE_BE_TRIVAL_REJ_PRIM, PERF_TSE_BE_INPUT_PRIM);
      }
   );
   counter("Reused Vertices / Second", Counter::Units::None, [=]() {
          ...
          */
         return cbSum(PERF_PC_S_VERTEX_HITS) / time;
      }
   );
   ...
   counter("ALU / Vertex", Counter::Units::None, [=]() {
          ...
          */
         return safe_div(4 * cbSum(PERF_SP_VS_STAGE_FULL_ALU_INSTRUCTIONS), cbSum(PERF_PC_S_VS_INVOCATIONS));
      }
   );
   ...
   counter("EFU / Vertex", Counter::Units::None, [=]() {
          ...
          *   - Numerator has to be multiplied by four.
          */
         return safe_div(4 * cbSum(PERF_SP_VS_STAGE_EFU_INSTRUCTIONS), cbSum(PERF_PC_S_VS_INVOCATIONS));
      }
   );
   ...
   counter("% Shaders Busy", Counter::Units::Percent, [=]() {
         ...
         return percent(numerator, number_of_usptp * PERF_RBBM_US_STATUS_MASKED);
      }
   );
   counter("% Shaders Stalled", Counter::Units::Percent, [=]() {
          ...
          * PERFCOUNTER_GROUP_RBBM::COUNTABLE_6 = PERF_RBBM_STATUS_MASKED
          */
         return percent(PERF_SP_NON_EXECUTION_CYCLES, number_of_usptp * PERF_RBBM_US_STATUS_MASKED);
      }
   );
   counter("% Texture Pipes Busy", Counter::Units::Percent, [=]() {
          ...
          * PERFCOUNTER_GROUP_RBBM::COUNTABLE_6 = PERF_RBBM_STATUS_MASKED
          */
         return percent(PERF_TP_BUSY_CYCLES, number_of_usptp * PERF_RBBM_US_STATUS_MASKED);
      }
   );
   ...
   counter("Textures / Vertex", Counter::Units::None, [=]() {
          ...
          *   - Numerator has to be multiplied by four.
          */
         return safe_div(4 * cbSum(PERF_SP_VS_STAGE_TEX_INSTRUCTIONS), cbSum(PERF_PC_S_VS_INVOCATIONS));
      }
   );
   ...
   counter("Vertices Shaded / Second", Counter::Units::None, [=]() {
          ...
          * PERFCOUNTER_GROUP_BV_PC::COUNTABLE_25 = PERF_PC_VS_INVOCATIONS
          */
         return cbSum(PERF_PC_S_VS_INVOCATIONS) / time;
      }
   );
   ...
   counter("% BVH Fetch Stall", Counter::Units::Percent, [=]() {
          ...
          *   - TODO: provisional implementation, wasn't able to verify.
          */
         return percent(PERF_SP_SCH_STALL_CYCLES_RTU, PERF_RBBM_US_STATUS_MASKED);
      }
   );
   ...
   counter("% Stalled On System Memory", Counter::Units::Percent, [=]() {
          ...
          */
         return safe_div(PERF_UCHE_STALL_CYCLES_ARBITER, 4 * PERF_RBBM_US_STATUS_MASKED);
      }
   );
   counter("% Texture Fetch Stall", Counter::Units::Percent, [=]() {
          ...
          * PERFCOUNTER_GROUP_RBBM::COUNTABLE_6 = PERF_RBBM_STATUS_MASKED
          */
         return percent(cbSum(PERF_SP_STALL_CYCLES_TP), number_of_usptp * PERF_RBBM_US_STATUS_MASKED);
      }
   );
   ...
   counter("% Vertex Fetch Stall", Counter::Units::Percent, [=]() {
          ...
          * PERFCOUNTER_GROUP_RBBM::COUNTABLE_6 = PERF_RBBM_STATUS_MASKED
          */
         return percent(cbSum(PERF_PC_S_STALL_CYCLES_VFD), PERF_RBBM_US_STATUS_MASKED);
      }
   );
