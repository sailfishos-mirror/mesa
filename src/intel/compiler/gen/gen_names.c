...
static const char *const gen_opcode_names[] = {
   [GEN_OP_ILLEGAL]  = "illegal",
   [GEN_OP_ADD3]     = "add3",
   [GEN_OP_ADD]      = "add",
   [GEN_OP_ADDC]     = "addc",
   [GEN_OP_AND]      = "and",
...
DEFINE_TO_STRING(gen_opcode_to_string, gen_opcode, gen_opcode_names)
DEFINE_FROM_STRING(gen_opcode_from_string, gen_opcode, gen_opcode_names)
