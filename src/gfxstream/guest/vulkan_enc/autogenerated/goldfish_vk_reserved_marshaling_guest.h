...
DEFINE_ALIAS_FUNCTION(reservedmarshal_VkPhysicalDeviceMaintenance6Features,
                      reservedmarshal_VkPhysicalDeviceMaintenance6FeaturesKHR)

DEFINE_ALIAS_FUNCTION(reservedmarshal_VkPhysicalDeviceMaintenance6Properties,
                      reservedmarshal_VkPhysicalDeviceMaintenance6PropertiesKHR)

DEFINE_ALIAS_FUNCTION(reservedmarshal_VkBindMemoryStatus, reservedmarshal_VkBindMemoryStatusKHR)

DEFINE_ALIAS_FUNCTION(reservedmarshal_VkBindDescriptorSetsInfo,
                      reservedmarshal_VkBindDescriptorSetsInfoKHR)

DEFINE_ALIAS_FUNCTION(reservedmarshal_VkPushConstantsInfo, reservedmarshal_VkPushConstantsInfoKHR)

DEFINE_ALIAS_FUNCTION(reservedmarshal_VkPushDescriptorSetInfo,
                      reservedmarshal_VkPushDescriptorSetInfoKHR)

DEFINE_ALIAS_FUNCTION(reservedmarshal_VkPushDescriptorSetWithTemplateInfo,
                      reservedmarshal_VkPushDescriptorSetWithTemplateInfoKHR)
...
DEFINE_ALIAS_FUNCTION(reservedmarshal_VkPhysicalDevicePipelineProtectedAccessFeatures,
                      reservedmarshal_VkPhysicalDevicePipelineProtectedAccessFeaturesEXT)
