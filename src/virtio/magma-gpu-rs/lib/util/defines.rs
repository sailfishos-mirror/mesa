...
pub const MAGMA_MAP_CACHE_MASK: u32 = 0x0f;
pub const MAGMA_MAP_CACHE_CACHED: u32 = 0x01;
pub const MAGMA_MAP_CACHE_UNCACHED: u32 = 0x02;
pub const MAGMA_MAP_CACHE_WC: u32 = 0x03;
/// Access flags (not in virtio_gpu spec)
pub const MAGMA_MAP_ACCESS_MASK: u32 = 0xf0;
pub const MAGMA_MAP_ACCESS_READ: u32 = 0x10;
...
pub const MAGMA_GPU_HANDLE_TYPE_MEM_SHM: u32 = 0x0004;
pub const MAGMA_GPU_HANDLE_TYPE_MEM_ZIRCON: u32 = 0x0005;

pub const MAGMA_GPU_HANDLE_TYPE_SIGNAL_OPAQUE_FD: u32 = 0x0010;
pub const MAGMA_GPU_HANDLE_TYPE_SIGNAL_SYNC_FD: u32 = 0x0020;
pub const MAGMA_GPU_HANDLE_TYPE_SIGNAL_OPAQUE_WIN32: u32 = 0x0030;
pub const MAGMA_GPU_HANDLE_TYPE_SIGNAL_ZIRCON: u32 = 0x0040;
pub const MAGMA_GPU_HANDLE_TYPE_SIGNAL_EVENT_FD: u32 = 0x0050;
...
impl Handle {
    ...
    pub fn try_clone(&self) -> Result<Handle> {
        let clone = self
            .os_handle
            .try_clone()
            .map_err(|_| Error::InvalidMagmaHandle)?;
        Ok(Handle {
            os_handle: clone,
