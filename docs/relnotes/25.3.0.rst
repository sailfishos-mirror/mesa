...
Starting with Mesa 25.3.0, we no longer support the Vulkan API on Linux
kernel versions older than 6.0 due to the deprecation of implicit
synchronization in favor of the dma-buf sync file import/export ioctls.
More information can be found in MR
`!36783 <https://gitlab.freedesktop.org/mesa/mesa/-/merge_requests/36783>`__.
