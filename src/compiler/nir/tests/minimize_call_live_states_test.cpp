...
TEST_F(nir_minimize_call_live_states_test, no_live_states)
{
   ...
   check_nir_string(NIR_REFERENCE_SHADER(R"(
      ...
      impl main {
          ...
          32    %2 = @load_push_constant (%1 (0x0)) (base=0, access=none, range=0, align_mul=4, align_offset=0)
...
TEST_F(nir_minimize_call_live_states_test, life_intrinsics)
{
   ...
   check_nir_string(NIR_REFERENCE_SHADER(R"(
      ...
      impl main {
          ...
          64     %5 = @load_push_constant (%4 (0x8)) (base=0, access=none, range=0, align_mul=8, align_offset=0)
          ...
          64    %10 = @load_push_constant (%9 (0x8)) (base=0, access=none, range=0, align_mul=8, align_offset=0)
...
TEST_F(nir_minimize_call_live_states_test, life_alu)
{
   ...
   check_nir_string(NIR_REFERENCE_SHADER(R"(
      ...
      impl main {
          ...
          32     %9 = @load_push_constant (%8 (0x0)) (base=0, access=none, range=0, align_mul=4, align_offset=0)
...
TEST_F(nir_minimize_call_live_states_test, call_inside_if)
{
   ...
   check_nir_string(NIR_REFERENCE_SHADER(R"(
      ...
      impl main {
          ...
          32     %5 = @load_push_constant (%4 (0x4)) (base=0, access=none, range=0, align_mul=4, align_offset=0)
          ...
          if %11 {
              ...
              32    %14 = @load_push_constant (%13 (0x4)) (base=0, access=none, range=0, align_mul=4, align_offset=0)
...
TEST_F(nir_minimize_call_live_states_test, call_inside_loop)
{
   ...
   check_nir_string(NIR_REFERENCE_SHADER(R"(
      ...
      impl main {
          ...
          32     %0 = load_const (0x00000000 = 0.000000)
          32     %1 = load_const (0x00000000)
          64     %2 = @load_push_constant (%1 (0x0)) (base=0, access=none, range=0, align_mul=8, align_offset=0)
          ...
          32    %13 = @load_push_constant (%12 (0x4)) (base=0, access=none, range=0, align_mul=4, align_offset=0)
          ...
          loop {
              ...
              if %18 {
                  ...
                  64    %21 = @load_push_constant (%20 (0x0)) (base=0, access=none, range=0, align_mul=8, align_offset=0)
                  ...
                  32    %32 = @load_push_constant (%31 (0x4)) (base=0, access=none, range=0, align_mul=4, align_offset=0)
